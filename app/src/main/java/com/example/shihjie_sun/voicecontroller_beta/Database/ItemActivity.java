...
public class ItemActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 如果是修改記事
        if (action.equals("com.example.shihjie_sun.voicecontroller_beta.Database.EDIT_ITEM")) {
            // 接收記事物件與設定標題、內容
...
*/
    ...
    class InitTask extends AsyncTask<Item, Void, Void> {
    ...
    public void initAdd(Item item) {
        SharedPreferences sharedPreferences =
                PreferenceManager.getDefaultSharedPreferences(this);
        // 讀取設定的預設顏色
        int color = sharedPreferences.getInt("DEFAULT_COLOR", -1);   //warning
        item.setColor(getColors(color));
        ...
        switch (id) {
            ...
            case R.id.record_sound:
                ...
                if (recordFile.exists()) {
                    // 詢問播放還是重新錄製的對話框
                    AlertDialog.Builder d = new AlertDialog.Builder(com.example.shihjie_sun.voicecontroller_beta.Database.ItemActivity.this);
            ...
            case R.id.play_sound:
                ...
                Intent playIntent = new Intent(
                    ...
                    Toast.makeText(this, "尚未錄音!", Toast.LENGTH_LONG).show();
                }
    ...
    private File configRecFileName(String prefix, String extension) {
        ...
        if (item.getRecFileName() != null && item.getRecFileName().length() > 0) {
            ...
            Log.d("11","111111111111111");
        }
        // 產生檔案名稱
        else {
            recFileName = FileUtil.getUniqueFileName();

            Log.d("22", "22222222222222222");
